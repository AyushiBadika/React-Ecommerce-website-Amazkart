  ...
  const fetchAllProductData = async () => {
    try {
      const response = await fetch(
        `https://ecommercebackend-wveh.onrender.com/products?rating=${filterParams.rating}&pricegt=${filterParams.pricegt}&pricelt=${filterParams.pricelt}&discount=${filterParams.discount}&reviews=${filterParams.reviews}`
      );
